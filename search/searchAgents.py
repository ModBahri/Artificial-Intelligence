        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not self.walls[nextx][nexty]:
                ...
                if nextState in self.corners:
                    ...
                    if cornerState not in visitedCorners:
                        visitedCorners.append(cornerState)
...
def cornersHeuristic(state, problem):
    ...
    manhattan = []
    for visit in unvisitedCorners:
        manhattan.append(util.manhattanDistance(visit, node))
        unvisitedCorners.remove(visit)
